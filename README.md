...
**Determine the RR (Relative Risk) threshold:** Choose the RR threshold, either 0 or 1, which determines the positive sample criteria used during training.
